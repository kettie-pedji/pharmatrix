...
class UsersDB {
    ...
    public function create($first_name, $last_name, $phone, $location, $email, $password, $role, $photo){
        $sql="insert into $this->tablename set first_name=?, last_name=?, phone=?, location=?, email=?, role=?, photo=?";
        $params= array ($first_name, $last_name, $phone, $location, $email, $password, $role, $photo);
        $this->db->prepare($sql, $params);
    }

    public function update($first_name, $last_name, $phone, $location, $email, $password, $role, $photo){
        $sql="update  $this->tablename set first_name=?, last_name=?, phone=?, location=?, email=?, role=?, photo=? where $this->tableid=?";
